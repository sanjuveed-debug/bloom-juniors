...
check('Phase 3: reward can be put on the shelf', await page.getByRole('button', { name: /put it on my shelf/i }).count() > 0)
await page.getByRole('button', { name: /put it on my shelf/i }).click()
