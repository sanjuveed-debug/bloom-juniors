...
export function KS2Dashboard({ profileName, progress, todayKey, gamesUnlocked, studyDoneCount, onNavigate, onSwitchProfiles, onParent, classroomLesson, fullAccess=true, onUpdateProgress }) {
