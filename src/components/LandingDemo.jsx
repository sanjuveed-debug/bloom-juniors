  ...
  return (
    <section className="px-4 pb-16 md:px-8">
      <div className="mx-auto max-w-xl">
        <h2 className="font-bubble text-3xl md:text-4xl text-center mb-2" style={{ color: '#422006' }}>
          Try it yourself — right now
        </h2>
        <p className="font-round text-sm text-center mb-8" style={{ color: 'rgba(66,32,6,0.55)' }}>
        ...
        <div className="rounded-[28px] p-5 md:p-7"
          style={{ background: '#FFFFFF', border: `1.5px solid ${DEMO_COLOUR}40`, boxShadow: '0 8px 24px rgba(66,32,6,0.07)' }}>
          ...
          {!started ? (
            <div className="text-center py-8">
              ...
              >🎯</motion.div>
              <p className="font-bubble text-2xl mb-2" style={{ color: '#422006' }}>Count &amp; Match</p>
              <p className="font-round text-sm mb-6" style={{ color: 'rgba(66,32,6,0.6)' }}>
              ...
              <motion.button
                ...
                style={{ background: DEMO_COLOUR }}
              >
                ▶ Play the demo
              </motion.button>
              <p className="font-round text-xs mt-3" style={{ color: 'rgba(66,32,6,0.4)' }}>Tip: turn your sound on 🔊</p>
            </div>
          ) : (
            <>
              <AnimatePresence mode="wait">
                {!done ? (
                  ...
                  <motion.div key="done"
                    ...
                    <p className="font-bubble text-2xl mb-2" style={{ color: '#422006' }}>You matched them all!</p>
                    <p className="font-round text-sm mb-6 max-w-sm mx-auto" style={{ color: 'rgba(66,32,6,0.6)' }}>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                      ...
                      <motion.button
                        whileTap={{ scale: 0.95 }}
                        onClick={playAgain}
                        className="font-bubble text-lg px-8 py-4 rounded-2xl border-2 transition-colors"
                        style={{ color: 'rgba(66,32,6,0.7)', borderColor: 'rgba(66,32,6,0.18)' }}
                      >
                        🔄 Play again
                      </motion.button>
                    </div>
