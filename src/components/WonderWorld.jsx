...
export default function WonderWorld({ progress, profileName, ageGroup = 'early', onUpdateProgress, onBack }) {
  ...
  return <div className="min-h-screen bg-[#fff3da] pb-16 text-[#3b210f]">
    ...
    <AnimatePresence>{showTreasures&&<TreasureShelf collection={treasureCollection} onEquip={equipTreasure} onClose={()=>setShowTreasures(false)} profileName={profileName}/>}</AnimatePresence>
